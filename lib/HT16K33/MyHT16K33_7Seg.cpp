...
MyHT16K33_7Seg Name(I2C-Adresse);
...
void MyHT16K33_7Seg::setBrightness(byte brightness)
{
...
void MyHT16K33_7Seg::setDisplayMode(byte mode)
{
  byte _mode = mode;
...
void MyHT16K33_7Seg::setOperationMode(byte mode)
{
  byte _mode = mode;
...
boolean MyHT16K33_7Seg::statusBlank()
{
  return(isBlank);
}
...
void MyHT16K33_7Seg::sendFloatVal(float ausgabeWert)
{
...
void MyHT16K33_7Seg::sendFixedVal(int ausgabeWert, byte anzNachkomma, bool blankZero)
{
...
void MyHT16K33_7Seg::sendDigit(byte digT, byte digH, byte digZ, byte digE, byte dec)
{
  byte _digT = digT;
  byte _digH = digH;
  byte _digZ = digZ;
...
void MyHT16K33_7Seg::sendTime(byte ausgabeWertLinks, byte ausgabeWertRechts)
{
...
void MyHT16K33_7Seg::sendChar(char charT, char charH, char charZ, char charE)
{
  char _charT = charT;
  char _charH = charH;
  char _charZ = charZ;
...
void MyHT16K33_7Seg::sendString(char* str)
{
  char* _str = str;
...
void MyHT16K33_7Seg::sendCmd(byte cmd)
{
  Wire.beginTransmission(_i2cAdd);
  Wire.write(cmd);
...
void MyHT16K33_7Seg::writeDigits()
{
  Wire.beginTransmission(_i2cAdd);
...
byte MyHT16K33_7Seg::convertTo7SegCode(byte val)
{
